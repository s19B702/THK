...
public class Resistance_ver2 extends View {
    ...
    public Resistance_ver2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public class Set_resistance_value extends Activity {
            ...
            button4.setOnClickListener(new OnClickListener() {  //ボタンが押されたときの処理
                ...
                public void onClick(View view) {
                    ...
                    if (Alr_Ans != 0 && Use_Ans != 0) {
                        ...
                        if (Alr_Ans == Use_Ans) {
                            Intent intent = new Intent(Set_resistance_value.this, Result.class);
                        ...
                        Intent intent = new Intent(Set_resistance_value.this, Start_Activity.class);
                        startActivity(intent);
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(200, 100, 300, 200, p1);
        canvas.drawRect(310, 100, 400, 200, p2);
        canvas.drawRect(410, 100, 500, 200, p3);
        canvas.drawRect(510, 100, 600, 200, p4);
